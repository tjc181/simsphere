program test_water
  ...
  ! Expected results
  real, parameter :: f_exp = 2.94117594
  real, parameter :: fsub_exp = 2.94117641
  real, parameter :: wgg_exp = 0.999999821
  real, parameter :: w2g_exp = 1.0
  real, parameter :: f_time_exp = 2.94117546
  real, parameter :: fsub_time_exp = 2.94117641
  real, parameter :: wgg_time_exp = 0.999999642
  real, parameter :: w2g_time_exp = 1.0
  real, parameter :: f_frveg_exp = 2.94117498
  real, parameter :: fsub_frveg_exp = 2.94117641
  real, parameter :: wgg_frveg_exp = 0.999999523
