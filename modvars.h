C **  This file contains the declaration of the common blocks for the
C **  model.


      CHARACTER * 1 STMTYPE, STEADY, DUAL_TI
      ...
      real dens, ft
      parameter (dens=1.1)  ! Density of Air
      parameter (ft=1.0)
      ...
      COMMON /SND/ GM(50),TS(50),TD(50),Tdif_50,Tdif_s,
     /		   O_Pot_Tmp
      ...
      COMMON/STOMINIT/THV,THMAX,PSIG,RKW,VFL,BETA,B1,B2,PSICM,PSICE,
     #		      SC,ZP,MINTEMP,MAXTEMP,RCUT,RAF,RMIN,VEGHEIGHT

      COMMON/STOMCALC/FS,RSCRIT,PSIWC,PSIM,PSIE,RS,WPSI,RLPSI,
     #		      FC,FPSIE,RL,ZG,RLELF
      COMMON/CAPACINIT/VOLINI,JCAP,RKOCAP,ZSTINI,FRHGT,
     #                 FRZP,RCCAP,RZCAP,VOLREL
      COMMON/CAPACCALC/PSIST,PSIX,FST,DELTVST,VOLRMV,ZST,CAPACI,
     #		       FLUXGD,VOLIST,PSISUP
