...
*/ground_T = undefined
 ...
 4        format(4(I4,1X))
     ...
     &               'Air_Temperature_Foliage/C '
        ...
        WRITE (11,*) 'Specific_Humidity_In_Foliage/gKg-1 ',             &
     &               'Bowen_Ratio '
        ...
        WRITE(11,*) 'CO2_Concentration_Canopy/ppmv ',                   &
